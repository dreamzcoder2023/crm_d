        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="#" class="b-brand">
                    ...
                    <img src="{{ url('public/settings/' . $settings->logo) }}" alt="" class="logo logo-lg"
                        style="height: 40px;width:50px;" /><span
                        class="sidebar_title logo logo-lg">{{ $settings->title }}</span>
                    <img src="{{ url('public/settings/' . $settings->sidebar_logo) }}" alt=""
                        class="logo logo-sm" />
                </a>
            </div>
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link"
                                    href="{{ route('admin.privatedashboard') }}">Private
                                    Dashboard</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Privillages</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.role.index') }}">Roles</a>
                            </li>
                            {{-- <li class="nxl-item"><a class="nxl-link" href="analytics.html">Analytics</a></li> --}}
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">User</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.user.index') }}">List</a>
                            </li>
                            {{-- <li class="nxl-item"><a class="nxl-link" href="analytics.html">Analytics</a></li> --}}
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Equipment</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.equipment.index') }}">List</a>
                            </li>
                            {{-- <li class="nxl-item"><a class="nxl-link" href="analytics.html">Analytics</a></li> --}}
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Equipment Type</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.equipmenttype.index') }}">List</a>
                            </li>
                            {{-- <li class="nxl-item"><a class="nxl-link" href="analytics.html">Analytics</a></li> --}}
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Equipment Type Model</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.equipmentmodel.index') }}">List</a>
                            </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Project</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.project.index') }}">List</a>
                            </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.product.index') }}">List</a>
                            </li>

                        </ul>
                    </li>
                    {{-- <li class="nxl-item">
                        <a href="{{ route('admin.task') }}" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-check-square"></i>
                            </span>
                            <span class="nxl-mtext">Task</span><span class="nxl-arrow"> --}}
                    ...
                    <li class="nxl-item">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-message-square"></i>
                            </span>
                            <span class="nxl-mtext">Communication</span><span class="nxl-arrow"> --}}
                                {{-- <i class="feather-chevron-right"></i> --}}
                            {{-- </span>
                        </a> --}}
                        {{-- <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-target"></i>
                            </span>
                            <span class="nxl-mtext">Monthly Planner</span><span class="nxl-arrow"> --}}
                                {{-- <i class="feather-chevron-right"></i> --}}
                            {{-- </span>
                        </a> --}}
                        {{-- <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-pen-tool"></i>
                            </span>
                            <span class="nxl-mtext">New Task</span><span class="nxl-arrow"> --}}
                                {{-- <i class="feather-chevron-right"></i> --}}
                            {{-- </span>
                        </a> --}}
                        {{-- <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-file-text"></i>
                            </span>
                            <span class="nxl-mtext">Other Task</span><span class="nxl-arrow"> --}}
                                {{-- <i class="feather-chevron-right"></i> --}}
                            {{-- </span>
                        </a> --}}
                        {{-- <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-info"></i>
                            </span>
                            <span class="nxl-mtext">Whats up Task</span><span class="nxl-arrow"> --}}
                                {{-- <i class="feather-chevron-right"></i> --}}
                            {{-- </span>
                        </a> --}}
                        {{-- <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-users"></i>
                            </span>
                            <span class="nxl-mtext">Other Departments</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="#">HR</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Admin</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Storage</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Finance</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="apps-storage.html">Admimnistrative
                                    Assistant</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-user-check"></i>
                            </span>
                            <span class="nxl-mtext">Account</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="#">Purchase</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Expenses</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Journal</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Receipt</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Stock</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Auding</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">GST</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">TDS & TXS</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Income Tax</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Company</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Document File</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-book"></i>
                            </span>
                            <span class="nxl-mtext">Legal</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="#">Notices</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="#">Notification</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather feather-settings"></i>
                            </span>
                            <span class="nxl-mtext">Settings</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="#">Business Settings</a></li> --}}
                            {{-- <li class="nxl-item"><a class="nxl-link" href="#">Notification</a></li> --}}
                        {{-- </ul>
                    </li> --}}
                    {{-- <li class="nxl-item nxl-hasmenu">
