                                 ...
                                 <div class="tab-content nxl-mega-menu-tabs-content">
                                     ...
                                     <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                         <div class="mb-4 rounded-3 border">
                                             <img src="{{ url('public/duralux/images/banner/mockup.png') }}"
                                     ...
                                     <div class="tab-pane fade" id="v-pills-applications" role="tabpanel">
                                         <div class="row g-4">
                                             ...
                                             <div class="col-lg-6">
                                                 <div class="nxl-mega-menu-image">
                                                     <img src="{{ url('public/duralux/images/general/full-avatar.png') }}"
                                         ...
                                         <div class="d-lg-flex align-items-center justify-content-between">
                                             ...
                                             <div class="mt-2 mt-lg-0">
                                                 <a href="https://bestwpware.com/cdn-cgi/l/email-protection#b9cecbd8c9dad6dddccbcaf9ded4d8d0d597dad6d4"
                                     ...
                                     <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                         <div class="row g-lg-4 nxl-mega-menu-integrations">
                                             ...
                                             <div class="col-lg-4">
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/app-store.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/spotify.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/figma.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/shopify.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/paypal.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                             ...
                                             <div class="col-lg-4">
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/gmail.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/dropbox.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/google-drive.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/github.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/gitlab.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                             ...
                                             <div class="col-lg-4">
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/facebook.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/pinterest.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/instagram.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/twitter.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                                 ...
                                                 <a href="javascript:void(0);" class="dropdown-item">
                                                     <div class="menu-item-icon">
                                                         <img src="{{ url('public/duralux/images/brand/youtube.png') }}"
                                                             alt="" class="img-fluid" />
                                                     </div>
                                     ...
                                     <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                         <div class="row g-4 align-items-center">
                                             ...
                                             <div class="col-xl-4">
                                                 <div class="nxl-mega-menu-image">
                                                     <img src="{{ url('public/duralux/images/banner/1.jpg') }}"
                                                         alt="" class="img-fluid" />
                                                 </div>
                                                 <div class="mt-4">
                                                     <a href="https://bestwpware.com/cdn-cgi/l/email-protection#790e0b18091a161d1c0b0a391e14181015571a1614"
                                                         class="fs-13 fw-bold">View all resources on Duralux &rarr;</a>
                                                 </div>
                                             </div>
                                         </div>
                                     </div>
                                                 ...
                                                 <div id="carouselResourcesCaptions" class="carousel slide"
                                                     ...
                                                     <div class="carousel-inner rounded-3">
                                                         <div class="carousel-item active">
                                                             <div class="nxl-mega-menu-image">
                                                                 <img src="{{ url('public/duralux/images/banner/6.jpg') }}"
                                                         ...
                                                         <div class="carousel-item">
                                                             <div class="nxl-mega-menu-image">
                                                                 <img src="{{ url('public/duralux/images/banner/5.jpg') }}"
                                                                     alt="" class="img-fluid d-block w-100" />
                                                             </div>
                                                             <div class="carousel-caption">
                                                                 <h5
                                                         ...
                                                         <div class="carousel-item">
                                                             <div class="nxl-mega-menu-image">
                                                                 <img src="{{ url('public/duralux/images/banner/4.jpg') }}"
                                                                     alt="" class="img-fluid d-block w-100" />
                                                             </div>
                                                             <div class="carousel-caption">
                                                                 <h5
                                                         ...
                                                         <div class="carousel-item">
                                                             <div class="nxl-mega-menu-image">
                                                                 <img src="{{ url('public/duralux/images/banner/3.jpg') }}"
                                                                     alt="" class="img-fluid d-block w-100" />
                                                             </div>
                                                             <div class="carousel-caption">
                                                                 <h5
                                                         ...
                                                         <div class="carousel-item">
                                                             <div class="nxl-mega-menu-image">
                                                                 <img src="{{ url('public/duralux/images/banner/2.jpg') }}"
                                                                     alt="" class="img-fluid d-block w-100" />
                                                             </div>
                                                             <div class="carousel-caption">
                                                                 <h5
                                                                     ...
                                                                     <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                         ...
                                                                         <div class="hstack gap-2 mt-3">
                                                                             <div class="avatar-image avatar-sm">
                                                                                 <img src="{{ url('public/duralux/images/avatar/1.png') }}"
                                                                                     alt=""
                                                                                     class="img-fluid" />
                                                                             </div>
                                                                             <a href="javascript:void(0);"
                                                             ...
                                                             <div class="col-xl-6">
                                                                 <div class="d-lg-flex align-items-center gap-3">
                                                                     ...
                                                                     <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                         ...
                                                                         <div class="hstack gap-2 mt-3">
                                                                             <div class="avatar-image avatar-sm">
                                                                                 <img src="{{ url('public/duralux/images/avatar/2.png') }}"
                                                                                     alt=""
                                                                                     class="img-fluid" />
                                                                             </div>
                                                                             <a href="javascript:void(0);"
                                                             ...
                                                             <div class="col-xl-6">
                                                                 <div class="d-lg-flex align-items-center gap-3">
                                                                     ...
                                                                     <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                         ...
                                                                         <div class="hstack gap-2 mt-3">
                                                                             <div class="avatar-image avatar-sm">
                                                                                 <img src="{{ url('public/duralux/images/avatar/3.png') }}"
                                                                                     alt=""
                                                                                     class="img-fluid" />
                                                                             </div>
                                                                             <a href="javascript:void(0);"
                                                             ...
                                                             <div class="col-xl-6">
                                                                 <div class="d-lg-flex align-items-center gap-3">
                                                                     ...
                                                                     <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                         ...
                                                                         <div class="hstack gap-2 mt-3">
                                                                             <div class="avatar-image avatar-sm">
                                                                                 <img src="{{ url('public/duralux/images/avatar/4.png') }}"
                                                                                     alt=""
                                                                                     class="img-fluid" />
                                                                             </div>
                                                                             <a href="javascript:void(0);"
                                             ...
                                             <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                                 <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                                     ...
                                                     <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                         ...
                                                         <div class="mt-4">
                                                             <a href="https://bestwpware.com/cdn-cgi/l/email-protection#b2c5c0d3c2d1ddd6d7c0c1f2d5dfd3dbde9cd1dddf"
             ...
             <div class="d-flex align-items-center">
                         ...
                         <div class="search-items-wrapper">
                             ...
                             <div class="users-result px-4 py-2">
                                     ...
                                     <div class="d-flex align-items-center gap-3">
                                         ...
                                         <div>
                                             ...
                                             <p class="fs-11 text-muted mb-0"><a
                                                     ...
                                                     class="__cf_email__"
                                                     data-cfemail="a3c2cfc6db8dc7c6cfcfc2e3ccd6d7cfccccc88dc0ccce">[email&#160;protected]</a>
                                             </p>
                                         </div>
                                     </div>
                                     ...
                                     <div class="d-flex align-items-center gap-3">
                                         ...
                                         <div>
                                             ...
                                             <p class="fs-11 text-muted mb-0"><a
                                                     href="https://bestwpware.com/cdn-cgi/l/email-protection"
                                                     class="__cf_email__"
                                                     data-cfemail="44233621212a6a27313021042b3130282b2b2f6a272b29">[email&#160;protected]</a>
                                             </p>
                                         </div>
                                     </div>
                                     <a href="javascript:void(0);" class="avatar-text avatar-md">
                                     ...
                                     <div class="d-flex align-items-center gap-3">
                                         ...
                                         <div>
                                             ...
                                             <p class="fs-11 text-muted mb-0"><a
                                                     href="https://bestwpware.com/cdn-cgi/l/email-protection"
                                                     class="__cf_email__"
                                                     data-cfemail="2c414d404d424549024d425a49556c43595840434347024f4341">[email&#160;protected]</a>
                                             </p>
                                         </div>
                                     </div>
                                     <a href="javascript:void(0);" class="avatar-text avatar-md">
                                     ...
                                     <div class="d-flex align-items-center gap-3">
                                         ...
                                         <div>
                                             ...
                                             <p class="fs-11 text-muted mb-0"><a
                                                     href="https://bestwpware.com/cdn-cgi/l/email-protection"
                                                     class="__cf_email__"
                                                     data-cfemail="8de6e8e3f9e5a3e5f8e3e8cde2f8f9e1e2e2e6a3eee2e0">[email&#160;protected]</a>
                                             </p>
                                         </div>
                                     </div>
                                     <a href="javascript:void(0);" class="avatar-text avatar-md">
                                 ...
                                 <div class="d-flex align-items-center justify-content-between mb-0">
                                     <div class="d-flex align-items-center gap-3">
                                         <div class="avatar-image rounded">
                                             <img src="{{ url('public/duralux/images/avatar/5.png') }}"
                                                 alt="" class="img-fluid" />
                                         </div>
                                         <div>
                                             <a href="javascript:void(0);"
                                             ...
                                             <p class="fs-11 text-muted mb-0"><a
                                                     href="https://bestwpware.com/cdn-cgi/l/email-protection"
                                                     class="__cf_email__"
                                                     data-cfemail="ed8c9f8e858488c38e8283889ead82989981828286c38e8280">[email&#160;protected]</a>
                                             </p>
                                         </div>
                                     </div>
                                     <a href="javascript:void(0);" class="avatar-text avatar-md">
                             ...
                             <div class="file-result px-4 py-2">
                                 ...
                                 <div class="d-flex align-items-center justify-content-between mb-4">
                                     <div class="d-flex align-items-center gap-3">
                                         <div class="avatar-image bg-gray-200 rounded">
                                             <img src="{{ url('public/duralux/images/file-icons/css.png') }}"
                                                 alt="" class="img-fluid" />
                                         </div>
                                         <div>
                                             <a href="javascript:void(0);"
                                 ...
                                 <div class="d-flex align-items-center justify-content-between mb-4">
                                     <div class="d-flex align-items-center gap-3">
                                         <div class="avatar-image bg-gray-200 rounded">
                                             <img src="{{ url('public/duralux/images/file-icons/zip.png') }}"
                                                 alt="" class="img-fluid" />
                                         </div>
                                         <div>
                                             <a href="javascript:void(0);"
                                 ...
                                 <div class="d-flex align-items-center justify-content-between mb-0">
                                     <div class="d-flex align-items-center gap-3">
                                         <div class="avatar-image bg-gray-200 rounded">
                                             <img src="{{ url('public/duralux/images/file-icons/pdf.png') }}"
                                                 alt="" class="img-fluid" />
                                         </div>
                                         <div>
                                             <a href="javascript:void(0);"
                 ...
                 {{-- <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                     <a href="javascript:void(0);" class="nxl-head-link me-0 nxl-language-link"
                         data-bs-toggle="dropdown" data-bs-auto-close="outside">
                         <img src="{{ url('public/duralux/vendors/img/flags/4x3/us.svg') }}" alt=""
                         ...
                         <div class="language-items-wrapper">
                             ...
                             <div class="row px-4 pt-3">
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/sa.svg') }}"
                                 ...
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/bd.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>Bengali</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/ch.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>Chinese</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/nl.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>Dutch</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select active">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/us.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>English</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/fr.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>French</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/de.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>German</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/in.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>Hindi</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/ru.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>Russian</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/es.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>Spanish</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/tr.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>Turkish</span>
                                     </a>
                                 </div>
                                 <div class="col-sm-4 col-6 language_select">
                                     <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                         <div class="avatar-image avatar-sm"><img
                                                 src="{{ url('public/duralux/vendors/img/flags/1x1/pk.svg') }}"
                                                 alt="" class="img-fluid" /></div>
                                         <span>Urdo</span>
                                     </a>
                                 </div>
                 ...
                 <div class="dropdown nxl-h-item">
                     ...
                     <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                         ...
                         <div class="notifications-item">
                             <img src="{{ url('public/duralux/images/avatar/2.png') }}" alt=""
                         ...
                         <div class="notifications-item">
                             <img src="{{ url('public/duralux/images/avatar/3.png') }}" alt=""
                                 class="rounded me-3 border" />
                             <div class="notifications-desc">
                                 <a href="javascript:void(0);" class="font-body text-truncate-2-line"> <span
                         ...
                         <div class="notifications-item">
                             <img src="{{ url('public/duralux/images/avatar/4.png') }}" alt=""
                                 class="rounded me-3 border" />
                             <div class="notifications-desc">
                                 <a href="javascript:void(0);" class="font-body text-truncate-2-line"> <span
                 ...
                 <div class="dropdown nxl-h-item">
                     <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button"
                         ...
                         @if (isset($user->profile))
                             <img src="{{ url('public/profile/' . $user->profile) }}" alt="user-image"
                                 class="img-fluid user-avtar me-0" />
                         @else
                             <img src="{{ url('public/profile/user.jpg') }}" alt="user-image"
                                 class="img-fluid user-avtar me-0" />
                         @endif
                     </a>
                     <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                                 ...
                                 <div>
                                     <h6 class="text-dark mb-0">{{ $user->name }}
                                         @if ($user->hasRole('admin'))
                                             <span
                                                 class="badge bg-soft-success text-success ms-1">{{ $user?->roles[0]?->name }}</span>
                                         @endif
                                     </h6>
                                     {{-- <span class="fs-12 fw-medium text-muted"><a
                                             href="https://bestwpware.com/cdn-cgi/l/email-protection"
                                             class="__cf_email__"
                                             data-cfemail="abcac7ced385cfcec7c7caebc4dedfc7c4c4c085c8c4c6">[email&#160;protected]</a></span> --}}
                                 </div>
                             </div>
                         </div>
                         {{-- <div class="dropdown">
                         ...
                         {{-- <div class="dropdown-divider"></div> --}}
                         <a href="{{ route('admin.profile.edit', $user->id) }}" class="dropdown-item">
                         ...
                         <a href="{{ route('admin.settings.edit', ['settings' => App\Models\Settings::where('id', 1)->first()?->id]) }}"
                             class="dropdown-item">
