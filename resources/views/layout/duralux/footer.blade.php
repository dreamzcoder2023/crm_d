 ...
 {{-- <footer class="footer">
     ...
     <div class="d-flex align-items-center gap-4">
         <a href="javascript:void(0);" class="fs-11 fw-semibold text-uppercase">crm</a>
 ...
 <script src="{{ url('public/duralux/vendors/js/daterangepicker.min.js') }}"></script>
 <script src="{{ url('public/duralux/vendors/js/apexcharts.min.js') }}"></script>
 <script src="{{ url('public/duralux/vendors/js/circle-progress.min.js') }}"></script>
 <!--! END: Vendors JS !-->
 <script src="{{ url('public/duralux/vendors/js/dataTables.min.js') }}"></script>
 <script src="{{ url('public/duralux/vendors/js/dataTables.bs5.min.js') }}"></script>
 <!--! BEGIN: Apps Init  !-->
 <script src="{{ url('public/duralux/js/common-init.min.js') }}"></script>
 <script src="{{ url('public/duralux/js/dashboard-init.min.js') }}"></script>
 <!--! END: Apps Init !-->
 <!--! BEGIN: Theme Customizer  !-->
 <script src="{{ url('public/duralux/js/theme-customizer-init.min.js') }}"></script>
 <!--! END: Theme Customizer !-->
 <script src="{{ url('public/duralux/js/proposal-init.min.js') }}"></script>
 <!-- vendors.min.js {always must need to be top} -->
 <script src="{{ url('public/duralux/vendors/js/select2.min.js') }}"></script>
 <script src="{{ url('public/duralux/vendors/js/select2-active.min.js') }}"></script>
 <!--! END: Vendors JS !-->
 <!--! BEGIN: Apps Init  !-->
 <script src="{{ url('public/duralux/js/customers-create-init.min.js') }}"></script>
 <!--! END: Apps Init !-->
