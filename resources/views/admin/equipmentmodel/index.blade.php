    ...
    <main class="nxl-container">
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Equipment Model</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.privatedashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item">Equipment Model</li>
                    </ul>
                </div>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="proposalSent">
            <div class="offcanvas-header ht-80 px-4 border-bottom border-gray-5">
                <div>
                    <h2 class="fs-16 fw-bold text-truncate-1-line">Create Equipment Model</h2>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <form action="{{ route('admin.equipmentmodel.store') }}" method="POST" id="roleForm">
                @csrf
                <div class="offcanvas-body">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-control" name="equipment_type_id">
                            ...
                            @foreach($equipment_type as $type)
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control " name="name"
                            value="" placeholder="Enter a equipment model name">
                        @error('name')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control " name="power_kw"
                            value="" placeholder="Enter a power (kw)">
                        @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="proposalSent_edit">
            <div class="offcanvas-header ht-80 px-4 border-bottom border-gray-5">
                <div>
                    <h2 class="fs-16 fw-bold text-truncate-1-line">Edit Equipment Model</h2>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="load_edit">
        ...
        <script>
            $(function() {
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('admin.equipmentmodel.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
            ...
            $(document).on('click', '.edit_model', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('admin.equipmentmodel.edit') }}",
                    data: {
                        id: id
                    },
                    cache: false,
            ...
            $(document).on('click', '.delete_model', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value == true) {
                        ...
                        $.ajax({
                            type: "post",
                            url: "{{ route('admin.equipmentmodel.delete') }}",
                            data: {
                                id: id,
                                 _token: "{{ csrf_token() }}"
                            },
                            ...
                            success: function(data) {
                                console.log('response', data);
                                $(function() {
                                    toastr.success('Equipment Model Deleted Success', {
                                        timeOut: 1000,
                                        fadeOut: 1000,
                                    });
                                });
