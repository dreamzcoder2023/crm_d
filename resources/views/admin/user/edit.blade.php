...
@section('content')
    ...
    <main class="nxl-container">
                                ...
                                <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                    <div class="card-body personal-info">
                                                ...
                                                <div class="mb-4 mb-md-0 d-flex gap-4 your-brand">
                                                    <div
                                                        ...
                                                        @if (isset($user->profile))
                                                            <img src="{{ url('public/profile/' . $user?->profile) }}"
                                                                class="upload-pic img-fluid rounded h-100 w-100"
                                                                id="get_Image" alt="">
                                                        @else
                                                            <img src="{{ url('public/profile/user.jpg') }}"
                                                                class="upload-pic img-fluid rounded h-100 w-100"
                                                                id="get_Image" alt="">
                                                        @endif
                                                        <div
                                                        ...
                                                        <input class="file-upload" id="profile-upload" type="file"
                                                            accept="image/*">
                                                    </div>
                                        ...
                                        <form action="{{ route('admin.user.update',$user->id) }}" method="POST"
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="phoneInput" class="fw-semibold">Mobile: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="phoneInput" class="fw-semibold">Address: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <div class="input-group-text"><i class="feather-map-pin"></i></div>
                                                        <textarea class="form-control" name="address" id="address" rows="3" placeholder="Enter Address">{{ $user->address }}</textarea>
                                                        {{-- <input type="text"
                                                            class="form-control @error('mobile') is-invalid @enderror"
                                                            name="mobile" value=""
                                                            oninput="this.value = this.value.replace(/[^0-9]/g, ''); if (this.value.length > 10) this.value = this.value.slice(0, 10);"
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="phoneInput" class="fw-semibold">Country: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="phoneInput" class="fw-semibold">Region: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="phoneInput" class="fw-semibold">Pincode: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                            ...
                                            {{-- <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="phoneInput" class="fw-semibold">Password: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <div class="input-group-text"><i class="feather-phone"></i></div>
                                            ...
                                            {{-- <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="phoneInput" class="fw-semibold">Confirm Password: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <div class="input-group-text"><i class="feather-phone"></i></div>
                                    ...
                                    {{-- <div class="card-body additional-info">
                                        <div class="mb-4 d-flex align-items-center justify-content-between">
                                            <h5 class="fw-bold mb-0 me-4">
                                                ...
                                                <span class="fs-12 fw-normal text-muted text-truncate-1-line">Communication
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            ...
                                            <div class="col-lg-8">
                                                <select class="form-select form-control max-select"
                                                    ...
                                                    <option value="danger" data-bg="bg-danger" selected>Promotions
                                                    </option>
                                                    ...
                                                    <option value="teal" data-bg="bg-teal" selected>High Budget
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-0 align-items-center">
                                            ...
                                            <div class="col-lg-8">
                                                <select class="form-control" data-select2-selector="privacy">
                                                    ...
                                                    <option value="everyone" data-icon="feather-globe" selected>Everyone
                                                    </option>
                                                    <option value="anonymous" data-icon="feather-users">Anonymous
                                                    </option>
                                                    <option value="ifollow" data-icon="feather-user-check">People I
                                                        Follow</option>
                                                    <option value="followme" data-icon="feather-eye">People Follow Me
                                                    </option>
                                                    <option value="customselectever" data-icon="feather-settings">Custom
                                                        Select Ever</option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="passwordTab" role="tabpanel">
                                    <form action="" method="POST"
                                        ...
                                        <div class="card-body pass-info">
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="Input" class="fw-semibold">Old Password: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="old_password"
                                                            ...
                                                            id="old_password" placeholder="old_password">
                                                        @error('old_password')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                        ...
                                                        <span class="text-success" style="display: none;"
                                                            id="passwordVerified">Password Verified</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="Input" class="fw-semibold">New Password: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <div class="input-group-text"><i class="feather-key"></i></div>
                                                        <input type="text" name="password"
                                                            class="form-control @error('password') is-invalid @enderror"
                                                            id="password" placeholder="password" disabled>
                                                        @error('password')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="Input" class="fw-semibold">Re-Enter New Password:
                                                    </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                ...
                                                <div class="col-lg-8 generate-pass">
                                                    <div class="input-group field">
                                                        ...
                                                        <input type="password" name="password"
                                                            class="form-control @error('password') is-invalid @enderror"
                                                            id="password" placeholder="Password Confirm">
                                                    </div>
                                        ...
                                        <center class="mt-3 mb-3">
                                            <button class="btn btn-success" type="submit" id="changePassword" disabled>
                                                Change Password
                                            </button>
                                        </center>
                                    </form>
        ...
        <script>
            $('#profile-upload').on('change', function(event) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        document.getElementById('get_Image').src = e.target.result;
                    };
            ...
            //     $.ajax({
            //         url: "{{ route('admin.changepassword.create') }}",
            //         type: "GET",
            //         data: {
            ...
            //                 $('#passwordVerified').css('display', 'block');
            //             } else {
            //                 $('#password').prop('disabled', true);
            //                 $('#password_confirmation').prop('disabled', true);
            //                 $('#changePassword').prop('disabled', true);
            //                 $('#passwordVerified').css('display', 'none');
            //             }
            //         }
            //     });
            // });
