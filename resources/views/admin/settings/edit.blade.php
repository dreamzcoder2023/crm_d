                    ...
                    <div class="col-lg-12">
                        <div class="card border-top-0">
                                ...
                                <ul class="nav nav-tabs flex-wrap w-100 text-center customers-nav-tabs" id="myTab"
                                    ...
                                    <li class="nav-item flex-fill border-top" role="presentation">
                                        <a href="javascript:void(0);" class="nav-link active" data-bs-toggle="tab"
                                            data-bs-target="#siteTab" role="tab">Site Settings</a>
                                    </li>
                                    {{-- <li class="nav-item flex-fill border-top" role="presentation">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="siteTab" role="tabpanel">
                                    <div class="card-body personal-info">
                                        ...
                                        <form action="{{ route('admin.settings.update', $settings->id) }}" method="POST"
                                             enctype="multipart/form-data" class="general-setting">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <div class="input-group-text"><i class="feather feather-award"></i>
                                                        </div>
                                                        <input type="text"
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="favicon" class="fw-semibold">Favicon: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <input type="file" id="myfile" name="favicon" accept="image/*">
                                                        {{-- <input type="file"
                                                    ...
                                                    @if (isset($settings->favicon))
                                                        <div class="image-container mt-2">
                                                            <img id="faviconImg" class="form-control"
                                                                src="{{ url('public/settings/' . $settings->favicon) }}"
                                                                alt="Favicon-Img" style="height: 60px; width: 60px;">
                                                            <!-- Hidden zoomed image for pop-up effect -->
                                                            <div class="zoom-image">
                                                                <img src="{{ url('public/settings/' . $settings->favicon) }}"
                                                                    alt="Zoomed Favicon" style="height: 200px;">
                                                            </div>
                                                        </div>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    @if (isset($settings->logo))
                                                        <div class="image-container mt-2">
                                                            <img class="form-control mt-2" id="faviconImg"
                                                                src="{{ url('public/settings/' . $settings?->logo) }}"
                                                                alt="logo-Img" style="height: 60px;width:60px;">
                                                            <!-- Hidden zoomed image for pop-up effect -->
                                                            <div class="zoom-image">
                                                                <img src="{{ url('public/settings/' . $settings->logo) }}"
                                                                    alt="Zoomed logo" style="height: 200px;">
                                                            </div>
                                                        </div>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="sidebar_logo" class="fw-semibold">Sidebar Logo: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <input type="file"
                                                           
                                                        accept="image/*" name="sidebar_logo">
                                                       
                                                    </div>
                                                    @if (isset($settings->sidebar_logo))
                                                        <div class="image-container mt-2">
                                                            <img class="form-control mt-2"
                                                                src="{{ url('public/settings/' . $settings?->sidebar_logo) }}"
                                                                alt="sidebar_logo-Img" style="height: 60px;width:60px;">
                                                            <!-- Hidden zoomed image for pop-up effect -->
                                                            <div class="zoom-image">
                                                                <img src="{{ url('public/settings/' . $settings->sidebar_logo) }}"
                                                                    alt="Zoomed logo" style="height: 200px;">
                                                            </div>
                                                        </div>
                                                    @endif
                                ...
                                <div class="tab-pane fade" id="passwordTab" role="tabpanel">
                                    {{-- <form action="#" method="POST">
                                        ...
                                        <div class="card-body pass-info">
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="Input" class="fw-semibold">Change Password: </label>
                                                </div>
